...
{
    public class CustomAccountFactoryService(IAccessTokenProviderAccessor accessor, IServiceProvider serviceProvider) : AccountClaimsPrincipalFactory<CustomUserAccount>(accessor)
    {
